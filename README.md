After creating json files run the command (git add .) with no parentheses and make sure to include the period with a space after "add" and hit enter this will track all changed and new files
